...
function videoPanelHtml(){
  ...
  <div class="fields">
    ...
    <label class="field">Nh\u00e0 cung c\u1ea5p<select id="videoTtsProvider"><option value="google">Google TTS</option><option value="vertex" ${["vertex","gemini"].includes(cfg.ttsProvider)?"selected":""}>Vertex AI Gemini TTS</option></select></label>
    ...
    <label class="field">Model Gemini<select id="geminiModel"><option value="gemini-2.5-flash-tts">Gemini 2.5 Flash TTS</option><option value="gemini-2.5-pro-tts" ${["gemini-2.5-pro-tts","gemini-2.5-pro-preview-tts"].includes(cfg.geminiModel)?"selected":""}>Gemini 2.5 Pro TTS</option><option value="gemini-3.1-flash-tts-preview" ${cfg.geminiModel==="gemini-3.1-flash-tts-preview"?"selected":""}>Gemini 3.1 Flash TTS</option></select></label>
