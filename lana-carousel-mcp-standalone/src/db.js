...
for (const [name, definition] of Object.entries({
  ...
  image_hue: "REAL NOT NULL DEFAULT 0",
  image_fit: "TEXT NOT NULL DEFAULT 'cover'",
  image_background: "TEXT NOT NULL DEFAULT '#181411'",
  image_flip_h: "INTEGER NOT NULL DEFAULT 0",
  image_flip_v: "INTEGER NOT NULL DEFAULT 0",
